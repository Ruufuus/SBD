...
CONSTRAINT medium_medium_constraint check (medium.medium in ('ANIME','MANGA','LIGHT NOVEL')),
CONSTRAINT medium_pk PRIMARY KEY (id),
CONSTRAINT medium_integrity_constraint check( (medium.medium = 'ANIME' AND studio_name IS NOT NULL) OR ((medium.medium IN ('MANGA', 'LIGHT NOVEL')
